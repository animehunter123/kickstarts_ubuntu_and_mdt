...
# Ensure that conda is installed with the respective environment
echo "CONDA ACTIVATING AND DOWNLOADING OUR VERSION: $PYTHONVERSION"
source ~/.bashrc
...
Open up a fresh bash, you will see (base), we need to activate it, so use...

conda activate $PYTHONVERSION

Now you are ready to launch the next script...
"
