...
# $LXPISO2 = '\\192.168.0.5\iso\Microsoft\Win10-20H2\Win10-x32x64-MultiLanguagePack\SW_DVD9_NTRL_Win_10_2004_32_64_ARM64_MultLng_LngPkAll_LIP_11C_LXP_ONLY_X22-47511.ISO'
