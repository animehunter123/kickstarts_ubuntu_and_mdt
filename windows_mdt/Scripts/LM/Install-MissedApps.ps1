...
New-SmbMapping -LocalPath j: -RemotePath "\\172.16.0.5\iso\Microsoft\Office2021+Visio+KMS\MDT-OfficeVisio2021" -UserName "lm\mdt" -Password 'INSERT_YOUR_PASSWORD_HERE' 
cp -recurse -force J:\* .
